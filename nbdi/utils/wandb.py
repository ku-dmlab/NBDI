...
from nbdi.utils.general_utils import flatten_dict, prefix_dict
from nbdi.utils.vis_utils import plot_graph
...
class WandBLogger:
    ...
    def __init__(self, exp_name, project_name, entity, name, path, conf, exclude=None):
        """
