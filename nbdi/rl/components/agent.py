...
from nbdi.utils.general_utils import ParamDict, get_clipped_optimizer, AttrDict, prefix_dict, map_dict, \
                                        nan_hook, np2obj, ConstantSchedule
from nbdi.utils.pytorch_utils import RAdam, remove_grads, map2np, map2torch
from nbdi.utils.vis_utils import add_caption_to_img, add_captions_to_seq
from nbdi.rl.components.normalization import DummyNormalizer
from nbdi.rl.components.policy import Policy
from nbdi.components.checkpointer import CheckpointHandler
from nbdi.rl.utils.mpi import sync_grads
...
class HierarchicalAgent(BaseAgent):
    ...
    def act(self, obs, reset_steps_since_hl=False):
