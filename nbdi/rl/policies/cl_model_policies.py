...
from nbdi.utils.pytorch_utils import no_batchnorm_update, ar2ten, ten2ar
from nbdi.rl.components.agent import BaseAgent
...
class ClModelPolicy(Policy):
    ...
    def _build_network(self):
        ...
        self._log_sigma = torch.tensor(self._hp.initial_log_sigma * np.ones(10, dtype=np.float32), 
    ...
    def _compute_action_dist(self, obs):
        ...
        if obs.shape[0] == 1:      
            ...
            # print("act.shape", act.shape) : torch.Size([1, 3])
