...
from nbdi.utils.general_utils import ParamDict, map_dict, AttrDict
from nbdi.utils.pytorch_utils import ten2ar, avg_grad_norm, TensorModule, check_shape, map2torch, map2np
from nbdi.rl.utils.mpi import sync_networks
        ...
        for _ in range(self._hp.update_iterations):
            ...
            with torch.no_grad():
                ...
                q_target = experience_batch.reward * self._hp.reward_scale + \
                                (1 - experience_batch.done) * pow(self._hp.discount_factor, experience_batch.skill_length/10) * value_next
