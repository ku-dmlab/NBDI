...
from nbdi.modules.layers import BaseProcessingNet, FCBlock
from nbdi.modules.losses import L2Loss
from nbdi.modules.variational_inference import stack
from nbdi.utils.general_utils import AttrDict, batchwise_assign, map_dict, \
    concat_inputs, listdict2dictlist, subdict
from nbdi.utils.general_utils import broadcast_final
...
class MLPLSTMCellInitializer(LSTMCellInitializer):
    ...
    def __init__(self, hp, cell, input_sz):
        ...
        from nbdi.modules.subnetworks import Predictor    # to avoid cyclic import
