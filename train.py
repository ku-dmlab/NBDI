...
from nbdi.components.data_loader import RandomVideoDataset
from nbdi.utils.general_utils import RecursiveAverageMeter, map_dict
from nbdi.components.checkpointer import CheckpointHandler, save_cmd, save_git, get_config_path
from nbdi.utils.general_utils import dummy_context, AttrDict, get_clipped_optimizer, \
                                                        AverageMeter, ParamDict
from nbdi.utils.pytorch_utils import LossSpikeHook, NanGradHook, NoneGradHook, \
                                                        DataParallelWrapper, RAdam
from nbdi.components.trainer_base import BaseTrainer
from nbdi.utils.wandb import WandBLogger
from nbdi.components.params import get_args
    ...
    def setup_logging(self, conf, log_dir):
        if not self.args.dont_save:
            ...
            if self._hp.logging_target == 'wandb':
                ...
                writer = WandBLogger(exp_name=exp_name, project_name=WANDB_PROJECT_NAME, entity=WANDB_ENTITY_NAME, name=self.args.wandb_name,
